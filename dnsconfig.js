...
D(REV('172.29.0.0/16'), REG_NONE, DnsProvider(DNS_BIND), NSSERVERS, 
    PTR('172.29.16.16', 'vc-us1sr-1.thefathacker.net.')
)
D(REV('172.31.0.0/16'), REG_NONE, DnsProvider(DNS_BIND), NSSERVERS, 
    ...
    PTR('172.31.16.16', 'vc-au1sr-1.thefathacker.net.'),
...
D(REV('fd03:580b:a316::/48'), REG_NONE, DnsProvider(DNS_BIND), NSSERVERS, 
    ...
    PTR('fd03:580b:a316:1f10::10', 'vc-au1sr-1.thefathacker.net.')
);